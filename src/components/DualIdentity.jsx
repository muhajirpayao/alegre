        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          <Reveal direction="left">
            <motion.div
              ...
              className="scroll-mt-36 border border-ink/10 bg-canvas-soft rounded-sm p-8 sm:p-10 h-full"
            >
              ...
              <p className="font-body text-ink-soft leading-relaxed mb-7">
                ...
                people who camp out with a laptop as often as they stop in for
                a quick cup. Consistent, unfussy, and open around the clock.
              </p>
          ...
          <Reveal direction="right" delay={0.12}>
            <motion.div
              ...
              whileHover={{ y: -4 }}
              transition={{ duration: 0.3, ease: [0.22, 1, 0.36, 1] }}
              className="scroll-mt-36 border border-ink/10 bg-ink text-canvas-soft rounded-sm p-8 sm:p-10 h-full"
            >
              ...
              <p className="font-body text-canvas-soft/80 leading-relaxed mb-7">
                ...
                streetwear, jackets, crewnecks, and outerwear, restocked
                often and picked with an actual eye — not a bargain bin.
              </p>
