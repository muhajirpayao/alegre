...
export default function Menu() {
  return (
    <section id="menu" className="scroll-mt-36 px-5 sm:px-8 py-20 sm:py-28 bg-canvas-soft border-y border-ink/10">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-2">
          {MENU.map((item, i) => (
            <Reveal key={item.name} delay={(i % 3) * 0.06} distance={16}>
              <motion.div
                whileHover={{ x: 4 }}
